...
_TRANSLATIONS: dict[str | None, gettext_module.NullTranslations] = {None: gettext_module.NullTranslations()}
_CURRENT = local()
_THOUSANDS_SEPARATOR = {'de_DE': '.', 'fr_FR': ' ', 'it_IT': '.', 'pt_BR': '.'}
_DECIMAL_SEPARATOR = {'de_DE': ',', 'it_IT': ',', 'pt_BR': ','}
